export const theCollegeDropout = {
    id: "OLAK5uy_mvz7Tr6ZqTX0GKxE4lP5ifCaE9Sx-AEjc",
    title: "The College Dropout",
    releaseDate: "February 10, 2004",
    coverImage: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-LiXOTHZ1Wvy7siLXEbsDUw6lbmLZ5M.png",
    tracks: [
        {
            title: "Intro",
            lyrics: `[Intro: DeRay Davis]
...
Think you could probably do somethin', for the kids, for graduation to sing?`,
            comments:
              `Intro is the perfect entry into Kanye's universe. It start with the school principal asking him to do something for the kids`
          },
        {
        title: "We Don't Care",
...
[Produced by Kanye West]`,
        comments:
          `...and Kanye being a complete troll by doing a song that musically is for children, but it's about selling drugs. 
          this sets the tone for all of Kanye's career. It's defiant. The children's choir takes it even further. "We don't care what people say"`,
      },
      {
...
She ain't walked in my shoes, I'm just not everybody`,
        comments:
          `He is immediately reprimanded and threatened. But he does not care: 
"I'm no longer confused, but, don't tell anybody
I'm about to break the rules, but, don't tell anybody
I got something better than school, so don't tell anybody
My momma would kill me, so, don't tell anybody
...
It's like he knows what he will become, he has THE VISION`,
      },
      {
        title: "All Falls Down",
        lyrics: `[Chorus: Syleena Johnson & Kanye West]
...
[Produced by Kanye West]`,
        comments:
          `This is Kanye expressing how self concious he is. And how he spends on stuff just to "up his self esteem"
...
`,
      ...
      {
        title: "I'll Fly Away",
        lyrics: `[Verse: The World Famous Tony Williams & DeRay Davis]
...
I'll fly away`,
        comments:
          `In his last song he finishes with the thought:
...
[Produced by Kanye West]`,
        comments:
          `Jesus Walks is one of my favorite dongs in this album. 
He again reisntates how people have told him what to do, 
But he will just follow his instincts and pry for the best. 
...
Even in his record he is ready for the consequences of doing what he believes, 
and not what they tell him to do. 
...
`,
        comments:
          `A crowd-pleaser and smoking anthem, Kanye, Talib, and Common take turns flexing their skills.` ,
      },
      {
        title: "Workout Plan",
        lyrics: `[Girl #1, Girl #2, Girl #3, Girls #2 and 3]
Ayy, wassup, girl?
Hey, girl
Hey, how you doin'?
...
Oh, shit`,
        comments:
          `This is the intro for the following track, “The New Workout Plan,” in which there are a bunch of girls talking about a new type of diet and exercise that’d make them look sexy.` ,
      },
      {
...
One and, you brought two friends, okay, three more
Now hop in the Benz
...
`,
        ...
        comments:
          `This song speaks to all of the pressure put on women by men. This song is a satire of workout mixtapes – it’s upbeat and has steady rhythm, making it excellent to exercise to. The song doesn’t actually give much in the way of workout advice, though, other than recommending sit-ups and crunches.

Kanye talks about how women are only valued for their bodies, and work out in an effort to “pull a rapper, an NBA player, man, at least a dude with a car.” The rapid nature of the song puts the listener in the frantic mind of a woman jumping through hoops as it were to please and attract men.` ,
      },
      {
        title: "Slow Jamz",
        lyrics: `[Intro: Jamie Foxx]
...
Very fast`,
        comments:
          `In this skit, the speaker delivers an incredibly sarcastic monologue to Jimmy which explains how degrees by themselves will not get you far in life. This continues the theme of The College Dropout, which is a satirical representation of America’s education system.` ,
      },
      {
        title: "School Spirit",
        lyrics: `[Intro]
...
There they was`,
        comments:
          `College is a great place… a great place to smoke weed, great place to have shady hook-ups…

… but not the best place to learn stuff, or so this song says. As Mark Twain once (supposedly) said, “I have never let my schooling interfere with my education.”
...
Who has that?`,
        comments:
          `Follow up to School Spirit Skit 2 where the son of the character from that skit talks about his life. Just like much of The College Dropout, this is an obvious criticism of the higher education system in America.` ,
      },
      {
        title: "Two Words",
...
(Yo, excuse me, dawg)
Still nowhere to go
(I apologize for the Westside, we finna get it jukin')
Ayo
...
`,
        comments:
          `The stories in this song are not actually all about Kanye’s family. Per Complex, Tarrey Torae (who sings “they don’t mean a thang” toward the end) helped Kanye with the stories for this song.` ,
      },
      {
        title: "Last Call",
        lyrics: `[Intro: JAY-Z]
